				...
				<h1>Xin Chào, {{Auth::user()->name}}</h1>
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Thống kê của cửa hàng</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="ecommerce-widget">
                          ...
                          <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Top bán chạy</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">{{$best_seller}}</h1>
                                        </div>
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                            <span class="icon-circle-small icon-box-xs text-success bg-success-light"><i class="fa fa-fw fa-arrow-up"></i></span><span class="ml-1">{{($best_seller/$producs_total)*100}}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                            <span class="icon-circle-small icon-box-xs text-success bg-success-light"><i class="fa fa-fw fa-arrow-up"></i></span><span class="ml-1">{{$user_percent}}%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Ghé thăm</h5>
                                        <div class="metric-value d-inline-block">
                        ...
                        <div class="row">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>{{$order['phone']}}</td>
                                                        <td>20</td>
                                                        <td>{{cart_value_by_id($order['id'])}}</td>
                                                    ...
                                                    @endforeach
                                                      @endif
                                                      <tr>
                                                        <td colspan="9"><a href="{{route('admin.order')}}" class="btn btn-outline-light float-right">Xem chi tiết</a></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header"> Khách hàng mua lại sản phẩm</h5>
                                    <div class="card-body">
                                        <div class="ct-chart ct-golden-section" style="height: 354px;"></div>
                                        <div class="text-center">
                                            <span class="legend-item mr-2">
                                                    <span class="fa-xs text-primary mr-1 legend-tile"><i class="fa fa-fw fa-square-full"></i></span>
                                            <span class="legend-text">Trả lại:{{$orders_cancel}}</span>
                                            </span>
                                            <span class="legend-item mr-2">

                                                    <span class="fa-xs text-secondary mr-1 legend-tile"><i class="fa fa-fw fa-square-full"></i></span>
                                            <span class="legend-text">Đang xử lý:{{$order_processing}}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <h5 class="mb-0">Sản phẩm được khuyến mại</h5>
                                    </div>
                                    <div class="card-body">
                            ...
                            <div class="col-xl-3 col-lg-12 col-md-6 col-sm-12 col-12">
                                ...
                                <!-- ============================================================== -->
                                <div class="card">
                                    <h5 class="card-header">Chiến dịch thực hiện hàng đầu</h5>
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                            ...
                            <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <p class="display-7 font-weight-bold"><span class="text-primary d-inline-block">100.0000.0000VNĐ</span><span class="text-success float-right">+9.45%</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="container">
		<div class="jumbotron">
			<!-- <div class="container">
				...
				<p>Hãy bắt đầu nào</p>
				<p>
					<a class="btn btn-primary btn-lg">chào mừng đến shop</a>
				</p>
			</div> -->
		</div>
