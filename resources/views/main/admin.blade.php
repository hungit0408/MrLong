                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="{{route('admin.edit')}}"><i class="fas fa-user mr-2"></i>Account</a>
                                <a class="dropdown-item" href="{{route('admin.changepass')}}"><i class="fas fa-key mr-2"></i>Thay đổi mật khẩu </a>
                                <a class="dropdown-item" href="#"><i class="fas fa-cog mr-2"></i>Setting</a>
                                <a class="dropdown-item" href="{{route('admin.user-logout')}}"><i class="fas fa-power-off mr-2"></i>Đăng xuất</a>
                            </div>
                            @endif
                        </li>
                    </ul>
        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="d-xl-none d-lg-none" href="{{route('admin.index')}}">Dashboard</a>
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <!-- Product manage menu -->
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-2" aria-controls="submenu-1-2">Quản lý sản phẩm </a>
                                            <div id="submenu-1-2" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{route('admin.product')}}">Danh sách sản phẩm</a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-3" aria-controls="submenu-1-3">quản lý danh mục</a>
                                            <div id="submenu-1-3" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{route('admin.category')}}">danh sách danh mục</a>
                                                        <a class="nav-link" href="{{route('admin.category.add')}}">Thêm danh mục</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-4" aria-controls="submenu-1-4">Quản lý tài khoản</a>
                                            <div id="submenu-1-4" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{route('admin.customer')}}">Xem user</a>
                                                        <a class="nav-link" href="{{route('register')}}">Thêm người dùng</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <!-- Banner manage menu -->
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-5" aria-controls="submenu-1-4">Quản lý banner</a>
                                            <div id="submenu-1-5" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="{{route('admin.banner')}}">Xem banner</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <!-- Order manage menu-->
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-6" aria-controls="submenu-1-4">quản lý đơn hàng</a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             Copyright © 2020 dvhung. All rights reserved. Dashboard by <a href="https://colorlib.com/wp/">dvhung</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
